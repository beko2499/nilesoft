(() => {
  ...
  const dict = {
    en: {
      ...
      title_home: 'Software Development Company in Ajman & UAE | NILESOFT', title_services: 'Web, App, SEO & Google Ads Services UAE | NILESOFT', title_work: 'Live Website, Store & Booking System Demos | NILESOFT', title_about: 'About NILESOFT | Ajman Software Development Company', title_contact: 'Contact NILESOFT Software Development UAE',
      ...
      svc_nav_1: 'Landing Page', svc_nav_2: 'Business Website', svc_nav_3: 'Online Store', svc_nav_4: 'Booking System', svc_nav_5: 'Mobile App', svc_nav_6: 'Automation & AI', svc_nav_7: 'SEO & Google Ads',
      ...
      svc7_t: 'Google Visibility: SEO + Ads', svc7_d: 'We combine sustainable organic visibility with fast paid reach so the right customer finds you at the moment of search and decision.',
      svc7_f1: 'Technical SEO audit, page optimization and local visibility', svc7_f2: 'Keyword and competitor research for organic and paid search', svc7_f3: 'Campaign setup with calls, WhatsApp and conversion tracking', svc7_f4: 'Continuous optimization and a clear monthly ranking, cost and results report',
      svc7_p: 'AED 1,500 / month', svc7_tm: 'Strategy and campaign in 7 days — ad spend excluded',
      seo_cap_t: 'SEO — your organic position', seo_cap_s: 'Technical foundations and content that compound over time',
      ads_cap_t: 'Google Ads — faster reach', ads_cap_s: 'Sharper targeting and measurable results',
      seo_label: 'Two paths, one goal', seo_promise: 'Show up now with ads while building your organic position for the future.',
      ...
      f_topic_l: 'I need',
      opt1: 'Professional one-page website', opt2: 'Complete business website', opt3: 'Online store', opt4: 'Booking & management system', opt5: 'Mobile app', opt6: 'Automation & AI', opt7: 'SEO & Google Ads',
      ...
      foot_about: 'NILESOFT — software and Google growth services for businesses in the UAE & Gulf: websites, stores, systems, apps, automation, SEO and Google Ads.',
      ...
      foot_services: 'Services', foot_s1: 'Websites & one-page sites', foot_s2: 'Online stores', foot_s3: 'Systems & apps', foot_s4: 'Automation & AI', foot_s5: 'SEO & Google Ads',
      foot_contact: 'Contact', foot_wa: 'Direct WhatsApp', foot_addr: 'Ajman, UAE',
      foot_rights: '\u00a9 2026 NILESOFT. All rights reserved.',
      ssn1: 'Service 01', ssn2: 'Service 02', ssn3: 'Service 03', ssn4: 'Service 04', ssn5: 'Service 05', ssn6: 'Service 06', ssn7: 'Service 07',
      ...
      j3_b: '3 · Week 3', j3_t: 'We publish to both stores', j3_s: 'iOS & Android + full training',
    ...
    ar: {
      ...
      title_home: 'شركة برمجة في عجمان والإمارات | نايل سوفت', title_services: 'خدمات المواقع والتطبيقات وSEO وإعلانات Google | نايل سوفت', title_work: 'نماذج مواقع وأنظمة وتطبيقات تجريبية | نايل سوفت', title_about: 'عن نايل سوفت | شركة تطوير برمجيات في عجمان', title_contact: 'تواصل مع نايل سوفت للبرمجة في عجمان والإمارات',
      ...
      svc_nav_1: 'صفحة تعريفية', svc_nav_2: 'موقع شركة', svc_nav_3: 'متجر إلكتروني', svc_nav_4: 'نظام حجوزات', svc_nav_5: 'تطبيق موبايل', svc_nav_6: 'أتمتة وذكاء اصطناعي', svc_nav_7: 'SEO وإعلانات Google',
      ...
      svc7_t: 'الظهور في Google عبر SEO والإعلانات', svc7_d: 'نجمع بين الظهور الطبيعي المستدام والوصول المدفوع السريع حتى يجدك العميل المناسب في لحظة البحث والقرار.',
      svc7_f1: 'تدقيق SEO تقني وتحسين الصفحات والظهور المحلي', svc7_f2: 'بحث كلمات ومنافسين يغطي النتائج الطبيعية والمدفوعة', svc7_f3: 'إعداد الحملات وربط المكالمات والواتساب والتحويلات', svc7_f4: 'تحسين مستمر وتقرير شهري واضح للترتيب والتكلفة والنتائج',
      svc7_p: '1,500 د.إ / شهرياً', svc7_tm: 'الخطة والحملة خلال 7 أيام — ميزانية الإعلان منفصلة',
      seo_cap_t: 'SEO — مكانك الطبيعي', seo_cap_s: 'أساس تقني ومحتوى يبنيان حضوراً يتراكم',
      ads_cap_t: 'Google Ads — وصول أسرع', ads_cap_s: 'استهداف أدق ونتائج قابلة للقياس',
      seo_label: 'مساران، هدف واحد', seo_promise: 'تظهر الآن بالإعلان، وتبني مكانك الطبيعي للمستقبل.',
      ...
      f_topic_l: 'أحتاج',
      opt1: 'صفحة تعريفية احترافية', opt2: 'موقع شركة متكامل', opt3: 'متجر إلكتروني', opt4: 'نظام حجوزات وإدارة', opt5: 'تطبيق موبايل', opt6: 'أتمتة وذكاء اصطناعي', opt7: 'SEO وإعلانات Google',
      ...
      foot_about: 'نايل سوفت — خدمات البرمجة والنمو عبر Google للأعمال في الإمارات والخليج: مواقع ومتاجر وأنظمة وتطبيقات وأتمتة وSEO وإعلانات Google.',
      ...
      foot_services: 'الخدمات', foot_s1: 'مواقع وصفحات تعريفية', foot_s2: 'متاجر إلكترونية', foot_s3: 'أنظمة وتطبيقات', foot_s4: 'أتمتة وذكاء اصطناعي', foot_s5: 'SEO وإعلانات Google',
      foot_contact: 'تواصل', foot_wa: 'واتساب مباشر', foot_addr: 'عجمان، الإمارات',
      foot_rights: '\u00a9 2026 نايل سوفت — جميع الحقوق محفوظة.',
      ssn1: 'الخدمة ٠١', ssn2: 'الخدمة ٠٢', ssn3: 'الخدمة ٠٣', ssn4: 'الخدمة ٠٤', ssn5: 'الخدمة ٠٥', ssn6: 'الخدمة ٠٦', ssn7: 'الخدمة ٠٧',
      ...
      j3_b: '٣ · الأسبوع الثالث', j3_t: 'ننشره في المتجرين', j3_s: 'iOS وAndroid + تدريب كامل',
